...
export const boliches = {
  ...
  modules: [
    ...
    },
    {
      ...
      title: "¿Te pasa que...?",
      bullets: [
        { emoji: "🏗️", text: "Tu ticketera cobra costo de servicio y encarece tus entradas." },
        { emoji: "🏗️", text: "Cada evento volvés a convocar desde cero." },
        { emoji: "🏗️", text: "Dependés de Instagram, publicidad o RRPP para llenar." },
        { emoji: "🏗️", text: "No sabés quiénes fueron ni podés contactarlos." },
        { emoji: "🏗️", text: "Llenás una fecha, pero no construís audiencia propia." },
        { emoji: "🏗️", text: "Invertís para atraer gente que después desaparece." },
      ],
    },
    {
      kind: "social_proof",
